...
public final class ItemMusicBinding implements ViewBinding {
  ...
  private ItemMusicBinding(@NonNull ConstraintLayout rootView, @NonNull TextView name,
      @NonNull TextView singer) {
  ...
  public static ItemMusicBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.singer;
      TextView singer = ViewBindings.findChildViewById(rootView, id);
      if (singer == null) {
        break missingId;
      }

      return new ItemMusicBinding((ConstraintLayout) rootView, name, singer);
    }
